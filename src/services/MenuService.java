...
public class MenuService {
    ...
    private void registerPlayer(Scanner scanner) {
        System.out.print("Введите идентификатор игрока: ");
        ...
        authenticationService.registerPlayer(playerId, username, password);
    ...
    private void debitFunds(Scanner scanner) {
        ...
        if (currentPlayer.getAccount().getBalance() - amount >= 0) {
            ...
            Transaction transaction = new Transaction(transactionId, currentPlayer.getPlayerId(), "Дебет", amount, new Date());
    ...
    private void creditFunds(Scanner scanner) {
        ...
        Transaction transaction = new Transaction(transactionId, currentPlayer.getPlayerId(), "Кредит", amount, new Date());
