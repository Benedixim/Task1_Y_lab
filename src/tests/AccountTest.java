...
public class AccountTest {
    ...
    @Test
    public void testCreditFundsWithDuplicateTransactionId() {
        Transaction transaction1 = new Transaction("1", "1", "credit", 50, new Date());
        account.addTransaction(transaction1);

        Transaction transaction2 = new Transaction("1", "1", "credit", 25, new Date());
        boolean result = account.creditFunds(transaction2);
    ...
    @Test
    public void testDebitFundsWithDuplicateTransactionId() {
        account.setBalance(100.0);
        ...
        Transaction transaction2 = new Transaction("1", "1", "credit", 25, new Date());
        boolean result = account.debitFunds(transaction2);
